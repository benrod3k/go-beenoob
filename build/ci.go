...
import (
	...
	"github.com/beenoob-protocol/go-beenoob/crypto/signify"
	"github.com/beenoob-protocol/go-beenoob/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/beenoob-protocol/go-beenoob/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/beenoob-protocol/go-beenoob/mobile")
