...
import (
	...
	"github.com/beenoob-protocol/go-beenoob/core/state"
	"github.com/beenoob-protocol/go-beenoob/core/state/pruner"
	"github.com/beenoob-protocol/go-beenoob/core/state/snapshot"
	...
	"github.com/beenoob-protocol/go-beenoob/trie"
...
var (
	snapshotCommand = &cli.Command{
		...
		Subcommands: []*cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale beenoob state data based on the snapshot",
				ArgsUsage: "<root>",
				Action:    pruneState,
				...
				Description: `
beenoob snapshot prune-state <state-root>
...
during the use of beenoob, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
beenoob snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     utils.GroupFlags(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
beenoob snapshot check-dangling-storage <state-root> traverses the snap storage 
...
`,
			},
			{
				...
				Flags:     utils.GroupFlags(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
beenoob snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     utils.GroupFlags(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
beenoob snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     utils.GroupFlags(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
beenoob snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'beenoob dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'beenoob dump', but uses the snapshots
