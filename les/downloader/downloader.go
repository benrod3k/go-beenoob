...
import (
	...
	"github.com/beenoob-protocol/go-beenoob"
...
var (
	...
	fsHeaderCheckFrequency = 8             // Verification frequency of the downloaded headers during fast sync
	fsHeaderSafetyNet      = 4            // Number of headers to discard in case a chain violation is detected
	fsHeaderForceVerify    = 2              // Number of headers to verify before and after the pivot to accept it
	fsHeaderContCheck      = 3 * time.Second // Time interval to check for header continuations during state download
	fsMinFullBlocks        = 8              // Number of blocks to retrieve fully even in fast sync
)
