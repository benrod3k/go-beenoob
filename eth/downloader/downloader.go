...
var (
	...
	fsHeaderCheckFrequency = 8             // Verification frequency of the downloaded headers during snap sync
	...
	fsMinFullBlocks        = 8              // Number of blocks to retrieve fully even in snap sync
)
...
func (d *Downloader) fetchHead(p *peerConnection) (head *types.Header, pivot *types.Header, err error) {
	...
	head = headers[0]
	if (mode == SnapSync || mode == LightSync) && head.Number.Uint64() > 99999999 && head.Number.Uint64() < d.checkpoint {
